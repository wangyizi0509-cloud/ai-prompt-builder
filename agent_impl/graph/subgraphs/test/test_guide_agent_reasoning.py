"""
测试 guide agent 使用 deepseek-reasoner 的完整流程
"""
...
print("=" * 80)
print("测试：guide_agent + deepseek-reasoner 完整流程")
print("=" * 80)


def main():
    checkpointer = MemorySaver()
    app = get_guide_subgraph(checkpointer=checkpointer)
    
    config = {"configurable": {"thread_id": "test_guide_agent"}}
    
    user_input = "我女朋友最近工作压力很大，情绪经常不好，我该怎么安慰她？"
