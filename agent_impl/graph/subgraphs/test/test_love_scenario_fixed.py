...
def main():
    ...
    config = {"configurable": {"thread_id": "test_love_scenario_fixed"}}
    
    user_input = "我想制定一个追求crush的计划，最近聊得挺好的，想进一步发展"
    ...
    if "__interrupt__" in result1:
        ...
        resume_payload = {
            "answers": {
                "0": "同事关系，认识了3个月，crush 比我大两岁",
                "1": "经常聊天，每天都会发消息，会主动分享生活，周末也会约出来吃饭",
            }
        }
        print(f"  用户回答:")
